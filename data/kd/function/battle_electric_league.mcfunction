...
execute run tbcs battle GEN_9_SINGLES @s vs tbcs:electric_league onwin {1:["pokedollars add @1 15000","loot give @1 loot kd:trainer_rewards/league","scoreboard players set @1 kd_electric_cd 1800","scoreboard players add @1 ranking 1"]}