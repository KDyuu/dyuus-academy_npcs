...
# Easy: level 1-29
execute if score @s temp_lvl matches 1..29 run tbcs battle GEN_9_SINGLES @s vs tbcs:bug_easy onwin {1:["pokedollars add @1 1000","loot give @1 loot kd:trainer_rewards/easy","scoreboard players set @1 kd_entoma_cd 1800"]}

# Normal: level 30-59
execute if score @s temp_lvl matches 30..59 run tbcs battle GEN_9_SINGLES @s vs tbcs:bug_normal onwin {1:["pokedollars add @1 2000","loot give @1 loot kd:trainer_rewards/normal","scoreboard players set @1 kd_entoma_cd 1800"]}

# Hard: level 60+
execute if score @s temp_lvl matches 60.. run tbcs battle GEN_9_SINGLES @s vs tbcs:bug_hard onwin {1:["pokedollars add @1 5000","loot give @1 loot kd:trainer_rewards/hard","scoreboard players set @1 kd_entoma_cd 1800"]}